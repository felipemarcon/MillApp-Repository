...
class EditComponentWidget extends StatefulWidget {
  const EditComponentWidget({
    super.key,
    required this.passarID,
    required this.passarDatatype,
  });

  final int? passarID;
  final MillPessoaStruct? passarDatatype;
...
class _EditComponentWidgetState extends State<EditComponentWidget> {
  ...
  void initState() {
    ...
    _model.txtNomeController ??=
        TextEditingController(text: widget.passarID?.toString());
    _model.txtNomeFocusNode ??= FocusNode();

    _model.txtFantasiaController ??=
        TextEditingController(text: widget.passarDatatype?.nomeFantasia);
    _model.txtFantasiaFocusNode ??= FocusNode();

    _model.txtEmailController ??=
        TextEditingController(text: widget.passarDatatype?.email);
    ...
    _model.txtLogradouroController ??=
        TextEditingController(text: widget.passarDatatype?.logradouro);
    _model.txtLogradouroFocusNode ??= FocusNode();

    _model.txtBairroController ??=
        TextEditingController(text: widget.passarDatatype?.bairro);
    _model.txtBairroFocusNode ??= FocusNode();

    _model.txtNumeroController ??=
        TextEditingController(text: widget.passarDatatype?.numero.toString());
    _model.txtNumeroFocusNode ??= FocusNode();

    _model.txtComplementoController ??=
        TextEditingController(text: widget.passarDatatype?.complemento);
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FlutterFlowDropDown<String>(
                                      controller:
                                          _model.tipoPessoaValueController ??=
                                              FormFieldController<String>(
                                        _model.tipoPessoaValue ??=
                                            widget.passarDatatype?.tipoPessoa,
                                      ),
                                    ...
                                    if (_model.tipoPessoaValue != 'Juridica')
                                      Expanded(
                                        child: wrapWithModel(
                                    ...
                                    if ((_model.tipoPessoaValue ==
                                            'Juridica') &&
                                        (_model.tipoPessoaValue != 'Fisica'))
                                      Expanded(
                                        child: wrapWithModel(
                                          model: _model.cnpjComponentModel,
                                          updateCallback: () => setState(() {}),
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  8.0, 0.0, 8.0, 0.0),
                                          child: TextFormField(
                                            controller: _model.txtCepController,
