...
import 'editar_atendimento_model.dart';
export 'editar_atendimento_model.dart';

class EditarAtendimentoWidget extends StatefulWidget {
  const EditarAtendimentoWidget({
    super.key,
    required this.editAtendimento,
  });

  final MillAtendimentoRecord? editAtendimento;

  @override
  State<EditarAtendimentoWidget> createState() =>
      _EditarAtendimentoWidgetState();
}

class _EditarAtendimentoWidgetState extends State<EditarAtendimentoWidget> {
  late EditarAtendimentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarAtendimentoModel());
    ...
    _model.dtAtendimentoController1 ??= TextEditingController(
        text: functions.formatarData(widget.editAtendimento!.dtAtendimento!));
    _model.dtAtendimentoFocusNode1 ??= FocusNode();

    _model.dtAtendimentoController2 ??=
        TextEditingController(text: widget.editAtendimento?.nomeSolicitante);
    _model.dtAtendimentoFocusNode2 ??= FocusNode();

    _model.tempoInicioController ??=
        TextEditingController(text: widget.editAtendimento?.horaInicial);
    _model.tempoInicioFocusNode ??= FocusNode();

    _model.tempoFinalController ??=
        TextEditingController(text: widget.editAtendimento?.horaFinal);
    ...
    _model.tempoResultadoController ??=
        TextEditingController(text: widget.editAtendimento?.tempoAtendimento);
    _model.tempoResultadoFocusNode ??= FocusNode();

    _model.textDescricaoController ??=
        TextEditingController(text: widget.editAtendimento?.descricao);
    _model.textDescricaoFocusNode ??= FocusNode();

    _model.txtCobrancaController ??= TextEditingController(
        text: widget.editAtendimento?.vlCobrancaDespesa.toString());
    _model.txtCobrancaFocusNode ??= FocusNode();

    _model.txtQtdkmController ??=
        TextEditingController(text: widget.editAtendimento?.qteKm.toString());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MillPessoaRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MillPessoaRecord> editarAtendimentoMillPessoaRecordList =
            snapshot.data!;
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    .dtAtendimentoController1Validator
                                    .asValidator(context),
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<MillPessoaRecord>(
                          stream: MillPessoaRecord.getDocument(
                              widget.editAtendimento!.contatoId!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
                            ...
                            final contatoSelectMillPessoaRecord =
                                snapshot.data!;
                            return FlutterFlowDropDown<String>(
                              controller:
                                  _model.contatoSelectValueController ??=
                                      FormFieldController<String>(
                                _model.contatoSelectValue ??=
                                    contatoSelectMillPessoaRecord.nome,
                              ),
                              options: editarAtendimentoMillPessoaRecordList
                                  .map((e) => e.nome)
                                  .toList(),
                              onChanged: (val) => setState(
                                  () => _model.contatoSelectValue = val),
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<MillPessoaRecord>(
                          stream: MillPessoaRecord.getDocument(
                              widget.editAtendimento!.colaboradorId!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
                            ...
                            final colaboradorSelectMillPessoaRecord =
                                snapshot.data!;
                            return FlutterFlowDropDown<String>(
                              controller:
                                  _model.colaboradorSelectValueController ??=
                                      FormFieldController<String>(
                                _model.colaboradorSelectValue ??=
                                    colaboradorSelectMillPessoaRecord.nome,
                              ),
                              options: editarAtendimentoMillPessoaRecordList
                                  .map((e) => e.nome)
                                  .toList(),
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    .dtAtendimentoController2Validator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: StreamBuilder<MillProjetoRecord>(
                              stream: MillProjetoRecord.getDocument(
                                  widget.editAtendimento!.projetoId!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                ...
                                final stackMillProjetoRecord = snapshot.data!;
                                return Stack(
                                  children: [
                                    Align(
                          ...
                          Expanded(
                            child: StreamBuilder<
                              ...
                              stream: MillClassificacaoAtendimentoRecord
                                  .getDocument(
                                      widget.editAtendimento!.classificacaoId!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                ...
                                final stackMillClassificacaoAtendimentoRecord =
                                    snapshot.data!;
                                return Stack(
                                  children: [
                                    Align(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<String>(
                                              controller: _model
                                                  ...
                                                  FormFieldController<String>(
                                                _model.dropClassificacaoValue ??=
                                                    stackMillClassificacaoAtendimentoRecord
                                                        .nome,
                                              ),
                                              options:
                                                  dropClassificacaoMillClassificacaoAtendimentoRecordList
                      ...
                      Row(
                        ...
                        children: [
                          Theme(
                            ...
                            child: Checkbox(
                              value: _model.checkRetrabalhoValue ??=
                                  widget.editAtendimento!.retrabalho,
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Digite aqui a descrição do atendimento...',
                            hintStyle:
                      ...
                      Row(
                        ...
                        children: [
                          Theme(
                            ...
                            child: Checkbox(
                              value: _model.checkAdicionalValue ??=
                                  widget.editAtendimento!.cobrancaAdicional,
                              onChanged: (newValue) async {
                                setState(() =>
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await widget.editAtendimento!.reference
                                      .update(createMillAtendimentoRecordData(
                                    nomeSolicitante:
                                      ...
                                      await showDialog<bool>(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: const Text(
                                                    'Ao excluir o atendimento você não perderá o acesso aos dados.'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
