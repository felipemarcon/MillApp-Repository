...
import 'cadastro_pessoa_model.dart';
export 'cadastro_pessoa_model.dart';

class CadastroPessoaWidget extends StatefulWidget {
  const CadastroPessoaWidget({super.key});

  @override
  State<CadastroPessoaWidget> createState() => _CadastroPessoaWidgetState();
}

class _CadastroPessoaWidgetState extends State<CadastroPessoaWidget> {
  late CadastroPessoaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroPessoaModel());
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    if (_model
                                                            .tipoPessoaValue ==
                                                        'Fisica') {
                                                      await MillPessoaRecord
                                                          .collection
                                                          .doc()
                                                          .set({
                                                        ...createMillPessoaRecordData(
                                                          nome: _model
                                                              .txtNomeController
                                                              .text,
                                                          nomeFantasia: _model
