...
class EditarPessoaWidget extends StatefulWidget {
  ...
  final MillPessoaRecord? cadastro;
...
class _EditarPessoaWidgetState extends State<EditarPessoaWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.cadastro?.tipoPessoa == 'Fisica') {
        setState(() {
          _model.tipoPessoaValueController?.value = 'Fisica';
        });
        setState(() {
          _model.cpfComponentModel.txtCPFController?.text =
              widget.cadastro!.documento;
        });
      } else {
        setState(() {
          _model.tipoPessoaValueController?.value = 'Juridica';
        });
        setState(() {
          _model.cnpjComponentModel.txtCnpjController?.text =
              widget.cadastro!.documento;
        });
      }
    });
    ...
    _model.txtFantasiaController ??=
        TextEditingController(text: widget.cadastro?.nomeFantasia);
    ...
    _model.txtCepController ??=
        TextEditingController(text: widget.cadastro?.cep);
    _model.txtCepFocusNode ??= FocusNode();

    _model.txtLogradouroController ??=
        TextEditingController(text: widget.cadastro?.logradouro);
    _model.txtLogradouroFocusNode ??= FocusNode();

    _model.txtBairroController ??=
        TextEditingController(text: widget.cadastro?.bairro);
    _model.txtBairroFocusNode ??= FocusNode();

    _model.txtNumeroController ??=
        TextEditingController(text: widget.cadastro?.numero.toString());
    _model.txtNumeroFocusNode ??= FocusNode();

    _model.txtComplementoController ??=
        TextEditingController(text: widget.cadastro?.complemento);
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          if (_model.tipoPessoaValue !=
                                            ...
                                            Expanded(
                                              child: wrapWithModel(
                                                model: _model.cpfComponentModel,
                                                updateCallback: () =>
                                                    setState(() {}),
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: const Text(
                                                                    'Deseja Excluir?'),
                                                                content: const Text(
                                                                    'Ao excluir essa pessoa, você não possuíra mais os acessos ao seus dados.'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
